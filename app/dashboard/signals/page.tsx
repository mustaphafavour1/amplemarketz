            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <span className="text-[14px] font-semibold text-[#111111]">{signal.person}</span>
                  <span className="text-[13px] text-[#9A9A9A]">· {signal.company}</span>
                </div>
                <p className="text-[13px] text-[#5C5C5C]">{signal.signal}</p>
              </div>

              {/* Zone 3: Pill + source */}
              <div className="w-[160px] shrink-0">
                <div className="mb-1"><SignalPill type={signal.type} /></div>
                <div className="text-[11px] text-[#9A9A9A]">via {signal.source} · {signal.time}</div>
              </div>
