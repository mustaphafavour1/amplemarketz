    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-[15px] font-semibold text-[#111111]">All Prospects</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#D4E4EE] bg-[#F8FAFF]">
                ...
                <th className="text-left px-4 py-2.5 text-[11px] font-semibold text-[#9A9A9A] uppercase tracking-wider">Contact</th>
                <th className="text-left px-4 py-2.5 text-[11px] font-semibold text-[#9A9A9A] uppercase tracking-wider">Actions</th>
              </tr>
            </thead>
            <tbody>
              {leads.map((lead, i) => (
                ...
                >
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <Link href={`/dashboard/prospects/sarah-chen`}>
                          <span className="text-[13px] font-semibold text-[#111111] hover:text-[#4361EE] transition-colors cursor-pointer">{lead.name}</span>
                        </Link>
                        <div className="text-[11px] text-[#9A9A9A]">{lead.title}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-[13px] text-[#5C5C5C]">{lead.company}</td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <a href={`mailto:${lead.email}`} className="text-[#9A9A9A] hover:text-[#4361EE] transition-colors"><Mail size={13} /></a>
                      <a href="#" className="text-[#9A9A9A] hover:text-[#4361EE] transition-colors"><Link2 size={13} /></a>
                    </div>
                  </td>
                  <td className="px-4 py-3">
